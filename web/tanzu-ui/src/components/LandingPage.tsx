...
const LandingPage: React.FC = () => {
    ...
    return (
        <Section>
            <Header> 
                <img src={"tce-logo.png"} alt="Logo"/>
                <Title>Welcome to the Tanzu Community Edition Launcher</Title>
            </Header>
            <Description>Tanzu Community Edition (TCE) is VMware's Open Source Kubernetes distribution. This installer will guide you through the installation of clusters necessary to get started with Kubernetes and TCE.
For more details see the getting started guide.</Description>
                            ...
                            <CdsCard aria-labelledby="containerOfCards1" key={index}>
                                <div cds-layout="vertical gap:md">
                                    ...
                                    <div cds-text="body light">
                                        <ButtonContainer>
                                            <CdsButton status="primary" onClick={()=> navigate('/docker')}>
                                                Deploy
                                            </CdsButton>
                                        </ButtonContainer>
                                    </div>
